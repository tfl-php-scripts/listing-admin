...
?>
 ...
 <p><label><strong>E-Mail:</strong></label><br>
 <textarea name="email" cols="50" rows="8" style="height: 220px; margin: 0 1% 0 0; width: 99%;"></textarea></p>
...
elseif (isset($_POST['action']) && $_POST['action'] == 'E-Mail Affiliate') {
 ...
 $mailAffiliate = $jaguars->sendAffEmail($template, $list, $affiliateid, $s, $b, $listingid);
...
elseif (isset($_POST['action']) && $_POST['action'] == 'Email Affiliates') {
 ...
 $b = isset($_POST['email']) && !empty($_POST['email']) ? $tigers->cleanMys($_POST['desc']) : 'n';
 $s = isset($_POST['subject']) && !empty($_POST['desc']) ? $tigers->cleanMys($_POST['subject']) : 'n';
...
elseif (isset($_POST['action']) && $_POST['action'] == 'E-Mail Member') {
 ...
 $b = empty($email) ? 'n' : trim($_POST['email']);
...
elseif (isset($_POST['action']) && $_POST['action'] == 'Email Members') {
 ...
 $e = !isset($_POST['email']) || empty($_POST['email']) ? 'n' : trim($_POST['email']);
...
?>
 ...
 <p><label><strong>E-Mail:</strong></label><br>
 <textarea name="email" cols="50" rows="8" style="height: 120px; margin: 0 1% 0 0; width: 99%;"></textarea></p>
