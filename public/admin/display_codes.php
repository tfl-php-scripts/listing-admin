...
(<samp>ASC</samp> or <smap>DESC</samp>) on the 
...
<tbody><tr>
 ...
 "fanlisting/codes/"), and 'n' to turn them off.</td>
</tr></tbody>
<tbody><tr>
...
<tbody><tr>
 ...
 the joined list, and 'n' to not display them.</td>
</tr></tbody>
<tbody><tr>
...
<tbody><tr>
 <td class="t">$list</td>
 <td class="d">Set to 'y' to display subcategories with the parent categories in
 the category list of your listings, and 'n' to not display them.</td>
</tr></tbody>
<tbody><tr>
...
<tbody><tr>
 ...
 option is turned off, so will your random joined listings.</td>
</tr></tbody>
<tbody><tr>
...
<tbody><tr>
 ...
 turned off, so will your random owned listings.</td>
</tr></tbody>
<tbody><tr>
...
<tbody><tr>
 ...
 returns the amount of categories with listings under them.</td>
</tr></tbody>
<tbody><tr>
...
<tbody><tr>
 ...
 field, the symbol is not needed.</td>
</tr></tbody>
<tbody><tr>
 <td class="t">$fKey</td>
 <td class="d">The fanlisting ID; for collective, use 0, e.g.: 
...
<ins>don't</ins> insert a comma.</p>
<code>
&#60;?php<br>
# -----------------------------------------------------------<br>
require("jac.inc.php");<br>
...
above. Once the last field has been set, do <ins>not</ins> set a comma.</p>
<code>
&#60;?php<br>
# -----------------------------------------------------------<br>
require("jac.inc.php");<br>
...
$fave_field_e = array(<br>
&#160;"Favourite Character(s)" => array('All', 'Draco', 'Ginny', 'Harry', 'Hermione', 'Neville', 'Ron'),<br>
&#160;"Favourite Couple(s)" => array('All', 'Draco/Ginny', 'Draco/Harry', 'Draco/Hermione', 'Ginny/Harry',<br>
...
<tbody><tr>
 ...
 returning an HTML template of your statistics.</td>
</tr></tbody>
</table>
