...
?>
<p>The following form should be used to contact the owner of the <?php echo $ctype; ?> and/or to apply for 
...
?>
<p>The affiliation/contact form is currently <strong>closed</strong>. If you are in dire need of e-mailing the
