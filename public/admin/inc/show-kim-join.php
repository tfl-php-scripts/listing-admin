...
if(isset($_POST['action']) && $_POST['action'] == 'Join List') {
 ...
 $ck = $tigers->cleanMys($_POST['captchak']);
...
<fieldset>
 ...
 <input name="visible" checked="checked" class="input3" type="radio" value="0"<?php echo $mark; ?>> Yes 
 <input name="visible" class="input3" type="radio" value="1"<?php echo $mark; ?>> No</p>
 <p><strong>Comments:</strong><br<?php echo $mark; ?>>
 <textarea name="comments" class="input1" cols="50" rows="10" style="height: 150px; margin: 0 1% 0 0; width: 99%;"></textarea>
 </p>
</fieldset>
...
?>
 <p class="inputCaptcha">
  ...
  <input name="captcha" class="input1" style="width: 48%;" type="text"<?php echo $mark; ?>><br<?php echo $mark; ?>>
...
?>
 <p class="inputAntispam">
  ...
  <input name="mathproblem" class="input1" style="width: 48%;" type="text"<?php echo $mark; ?>>
 </p>
<?php 
 }
?>
...
<fieldset>
 ...
 <p class="tc">
  <input name="emailMe" checked="checked" class="input3" type="checkbox" value="y"<?php echo $mark; ?>> Send me my details!
 </p>
<?php 
 /** 
