...
/* 
 CHANGELOG: 
 - July 18th, 2010 by Tess <theirrenegadexxx@gmail.com> 
   Changed split() to explode() on line 153 
*/
...
class MagpieRSS
{
    ...
    public function concat(&$str1, $str2 = ''): void
    {
        if (!isset($str1)) {
            $str1 = '';
        }
    ...
    public function normalize(): void
    {
        ...
        if ($this->is_atom()) {
            ...
            foreach ($this->items as $i => $iValue) {
                ...
                $atom_date = $item['issued'] ?? $item['modified'];
                if ($atom_date) {
     ...
     *
     */
    public function create_parser($source, $out_enc, $in_enc, $detect): array
    {
    ...
    public function error($errormsg, $lvl = E_USER_WARNING): void
    {
