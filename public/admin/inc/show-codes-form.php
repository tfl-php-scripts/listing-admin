...
if(isset($_POST['action'])) {
 if($_POST['action'] == 'start') {
  $name     = $tigers->cleanMys($_POST['name']);
   ...
   if(!isset($_POST['captcha']) || $_POST['captcha'] != substr(sha1($postcap), 0, 6)) {
...
<?php 
  for($n = 1; $n <= $number; $n++) {
?>
 <p style="margin: 0;"><input name="numeric[]" type="hidden" value="<?php echo $n; ?>"<?php echo $markup; ?>></p>
...
?>
 ...
 <p><label>Number of Buttons:</strong><br>
